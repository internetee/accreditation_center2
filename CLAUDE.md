...
- Models: 10
- Routes: 114 across 17 controllers
- Async: 2 jobs
- Migrations: 29 total, 0 pending
- Auth: Devise + Pundit
...
- **TestCategory** (3a, 4v) — has_many :test_categories_tests, has_many :tests, has_many :questions
  scopes: active
- **User** (2a, 5v) — has_many :test_attempts, has_many :tests
...
**Services:** AccreditationResultsService, ApiConnector, ApiTokenService, AuthenticationService, BotAuthService, ContactService, DomainService, InvoiceService, OidcAuthenticationService, RegistrarAccreditationEligibility, ReppDomainService
**Jobs:** AccreditationExpiryNotificationJob, AccreditationSyncJob
